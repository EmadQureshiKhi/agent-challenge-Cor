...
import { SavedPrompt } from '@/types/prisma';
...
import ChatInterface from '@/app/chat/[id]/chat-interface';
            ...
            <Card className="relative max-h-full border-white/[0.1] bg-white/[0.02] p-4 backdrop-blur-sm backdrop-saturate-150 dark:bg-black/[0.02] sm:p-8">
              ...
              <div className="relative space-y-6">
                <div className="space-y-2 text-center">
                  ...
                  <div className="text-muted-foreground">
                    Subscribe to CordAi for <Badge>BETA</Badge> access.
                  </div>
                </div>
            ...
            <Card className="relative max-h-full border-white/[0.1] bg-white/[0.02] p-4 backdrop-blur-sm backdrop-saturate-150 dark:bg-black/[0.02] sm:p-8">
              ...
              <div className="relative space-y-6">
                <div className="space-y-2 text-center">
                  ...
                  <div className="text-muted-foreground">
                    Hold $CordAI tokens in your embedded wallet for{' '}
                    <Badge>BETA</Badge> access..
                  </div>
                </div>
                ...
                <div className="rounded-lg bg-white/[0.01] p-4 backdrop-blur-sm dark:bg-black/[0.01]">
                  <div className="mb-2 flex items-center justify-between">
                    <span className="text:xs font-medium sm:text-sm">
                      CordAi Tokens Required
                    </span>
                    <span className="text-base font-semibold sm:text-lg">
                      {getTrialTokensFloat()} CordAi
                    </span>
                  </div>
                </div>
